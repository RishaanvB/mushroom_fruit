  ...
  return (
    <Layout>
      ...
      <div className="faq-container">
        <section className="faq-container__aq-block">
          <i className="faq-container__chevron fas fa-chevron-down"></i>
          ...
          <p className="faq-answer">
            ...
            <span className="faq-answer__bold">
        ...
        <section className="faq-container__aq-block">
          ...
          <p className="faq-answer">
            <span className="faq-answer__bold">Yes, you definitely can,</span>
        ...
        <section className="faq-container__aq-block">
          ...
          <p className="faq-answer">
            ...
            <span className="faq-answer__bold">which is completely normal</span>
            .
          </p>
        </section>
