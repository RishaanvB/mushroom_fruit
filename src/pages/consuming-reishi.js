...
const ConsumingReishi = () => {
  ...
  return (
    <Layout pageTitle="Consuming reishi">
      ...
      <StyledContainer>
        <StyledHeader>1:How to consume</StyledHeader>

        <StyledFirstP>
          2:Consuming a Reishi mushroom is different from consuming just about
          any other mushroom. This is because of the very rigid texture of the
        ...
        <p style={{ margin: "1rem 0" }}>
          3:The most commonly used method is by boiling pieces of the Reishi
        ...
        />
        <p style={{ margin: "1rem 0" }}>
          4:Officia culpa eos illum maiores maxime ullam eaque sint iure
        ...
        <p style={{ margin: "1rem 0" }}>
          5:Officia culpa eos illum maiores maxime ullam eaque sint iure
          consequatur odio corporis ad. Deleniti iure ad eos necessitatibus
          itationem aliquam laudantium debitis veritatis hic dolor accusamus!
        </p>

        <StyledIntroTableParagraph>
          6:On this page “Consuming Reishi”, I will also dive deeper into the
      ...
      <StyledContainer>
        <StyledTableSub>
          7:Table with PubMed results – results found on 7 April 2021. Mushroom
          species was combined with the health related term in the regular
          search function.
        </StyledTableSub>
        <StyledBottomP>
          8:Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla
